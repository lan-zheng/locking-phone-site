  ...
  const englishPages = {
    ...
    membership: {
      ...
      sections: [
        ...
        ["benefits", "Pro benefits", "After the complimentary first one-time night, Pro lets you continue creating one-time lock plans or enable a schedule that repeats every day. It also includes the paid functionality identified in the current in-app paywall. Features depend on Apple Screen Time permission and supported iOS behavior."],
  ...
  const localizedPages = {
    "zh-Hans": {
      ...
      membership: ["会员服务协议", "Locking Phone Pro 提供的权益。", "本协议说明 Locking Phone Pro 订阅与永久买断服务，是《用户协议》的补充，并在你通过 App Store 购买付费产品时适用。", [
        ...
        ["benefits", "Pro 权益", "首个免费单次夜晚结束后，Pro 用户可以继续创建单次锁定，也可以开启每天重复的循环计划，并使用 App 当前付费页面明确列出的功能。功能依赖 Apple 屏幕使用时间授权及受支持的 iOS 行为。"],
    ...
    "zh-Hant": {
      ...
      membership: ["會員服務協議", "Locking Phone Pro 提供的權益。", "本協議說明 Locking Phone Pro 訂閱與永久買斷服務，是《使用者協議》的補充，並在你透過 App Store 購買付費產品時適用。", [
        ...
        ["benefits", "Pro 權益", "首個免費單次夜晚結束後，Pro 可繼續建立單次鎖定，也可開啟每天重複的循環計畫，並使用 App 當前付費頁明確列出的功能。功能依賴 Apple 螢幕使用時間授權與支援的 iOS 行為。"],
  ...
  const summaryTranslations = {
    es: {
      ...
      membership: ["Acuerdo del servicio Pro", "Qué incluye Locking Phone Pro.", "Se aplica a las suscripciones y a la compra de por vida realizadas en App Store.", [
        ["plans", "Planes", "Hay suscripción mensual, anual y compra única de por vida. El precio real aparece antes de confirmar. No existe una prueba automática de siete días."], ["benefits", "Ventajas Pro", "Tras la primera noche gratuita, Pro permite crear más bloqueos únicos o activar una repetición diaria."], ["activation", "Activación", "Apple activa y verifica el acceso. Restaura con la misma Cuenta de Apple."], ["subscriptions", "Suscripciones", "Se renuevan hasta que se cancelan; consulta el acuerdo de renovación automática."], ["lifetime", "De por vida", "Es una compra única sin renovación, disponible mientras la app siga ofreciéndose y siendo compatible."], ["refunds", "Cobros y reembolsos", "Apple procesa pagos y solicitudes de reembolso."], ["contact", "Contacto", "Escribe al correo de soporte para consultar el acceso Pro."]
      ]],
    ...
    ja: {
      ...
      membership: ["会員サービス規約", "Locking Phone Proの内容。", "App Storeで購入するサブスクリプションと買い切りに適用されます。", [
        ["plans", "プラン", "月額、年額、買い切りがあります。実際の価格は購入前に表示され、7日間の自動更新トライアルはありません。"], ["benefits", "Pro特典", "無料の1夜後も1回ロックを作成し、または毎日の繰り返しを有効にできます。"], ["activation", "有効化と復元", "Appleが購入を確認します。同じApple Accountで購入を復元してください。"], ["subscriptions", "サブスクリプション", "解約するまで自動更新されます。詳細は自動更新規約をご覧ください。"], ["lifetime", "買い切り", "更新のない1回購入で、アプリが提供・対応される間の利用権です。"], ["refunds", "請求と返金", "支払いと返金はAppleが処理します。"], ["contact", "連絡先", "Proについてはサポートへご連絡ください。"]
      ]],
    ...
    fr: {
      ...
      membership: ["Contrat du service Pro", "Ce que comprend Locking Phone Pro.", "Il s’applique aux abonnements et à l’achat à vie sur l’App Store.", [
        ["plans", "Formules", "Mensuelle, annuelle et achat unique à vie. Le prix réel apparaît avant confirmation. Aucun essai de 7 jours à renouvellement automatique."], ["benefits", "Avantages Pro", "Après la première nuit gratuite, créez d’autres verrouillages uniques ou activez la répétition quotidienne."], ["activation", "Activation", "Apple vérifie l’achat. Restaurez avec le même compte Apple."], ["subscriptions", "Abonnements", "Ils se renouvellent jusqu’à annulation; voir le contrat de renouvellement."], ["lifetime", "Achat à vie", "Achat unique sans renouvellement, valable tant que l’app reste proposée et prise en charge."], ["refunds", "Paiement et remboursement", "Apple traite les paiements et remboursements."], ["contact", "Contact", "Contactez l’assistance pour l’accès Pro."]
      ]],
    ...
    "pt-BR": {
      ...
      membership: ["Contrato do serviço Pro", "O que o Locking Phone Pro inclui.", "Aplica-se às assinaturas e à compra vitalícia na App Store.", [
        ["plans", "Planos", "Mensal, anual e compra vitalícia única. O preço real aparece antes da confirmação. Não há teste de 7 dias com renovação automática."], ["benefits", "Benefícios Pro", "Após a primeira noite gratuita, crie outros bloqueios únicos ou ative repetição diária."], ["activation", "Ativação", "A Apple verifica a compra. Restaure com a mesma Conta Apple."], ["subscriptions", "Assinaturas", "Renovam até o cancelamento; consulte o contrato de renovação."], ["lifetime", "Vitalício", "Compra única sem renovação, válida enquanto o app for oferecido e compatível."], ["refunds", "Pagamentos", "A Apple processa pagamentos e reembolsos."], ["contact", "Contato", "Fale com o suporte sobre acesso Pro."]
      ]],
